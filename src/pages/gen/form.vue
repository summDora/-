    ...
    <div>
      ...
      >
        ...
        <div slot="datetype" slot-scope="text">
          <span
            >{{ text.year }}-{{
              text.monthValue > 9 ? text.monthValue : "0" + text.monthValue
            }}-{{
              text.monthValue > 9 ? text.monthValue : "0" + text.monthValue
            }}&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
          <span
            >{{ text.hour > 9 ? text : "0" + text.hour }}:{{
              text.minute > 9 ? text.minute : "0" + text.minute
            }}:{{ text.second > 9 ? text.second : "0" + text.second }}</span
          >
        </div>
      </a-table>
      <a-drawer
...
import { fetchList } from "@/assets/api/gen/form";
