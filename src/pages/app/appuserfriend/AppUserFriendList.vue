...
<script>
  ...
  import TableForm from './AppUserFriendForm'
  const Columns = [
              {
          title: "",
          dataIndex: "id",
          ...
          key: "source",
              ...
              {
          title: "1.被添加 2.主动添加(同意之加一条记录)",
          dataIndex: "type",
          key: "type",
        },
              {
          title: "好友类型:1.好友 2.亲密好友",
          dataIndex: "friendType",
          key: "friendType",
        },
              {
          title: "好友备注",
          dataIndex: "friendNote",
          key: "friendNote",
        },
              {
          title: "",
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        postForm("/app/appuserfriend/page", params).then((res) => {
      ...
      // 删除菜单
      deleteRecord(id) {
        post("/app/appuserfriend/delete", [id]).then((res) => {
          if (res.code == 200) {
            this.getTableData();
            this.$message
                    .success(res.msg);
