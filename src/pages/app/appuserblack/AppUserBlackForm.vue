<template>
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="拉黑用户">
                <a-input placeholder="请输入拉黑用户" v-decorator="['blackUserId']"/>
              </a-form-item>

                                
              <a-form-item label="1.屏蔽 2.拉黑">
                <a-input placeholder="请输入1.屏蔽 2.拉黑" v-decorator="['status']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/app/appuserblack/update', values).then(() => {
            ...
            post('/app/appuserblack/add', values).then(() => {
