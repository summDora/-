    ...
    <a-form :form="form" v-bind="layout">
                ...
                <a-date-picker
                    ...
                    :placeholder="`user_id`"/>
                                                          ...
                                                          <a-form-item label="bind_id">
                <a-input placeholder="bind_id" v-decorator="['bindId']"/>
              </a-form-item>
                                      <a-form-item label='bind_id'>
                <a-input-number v-decorator="['bindId' ]" :min="1" :max="999"/>
              </a-form-item>
                                      <a-form-item label="bind_id">
                <a-date-picker
                    style="width:100%"
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/app/appuserpaybind/update', values).then(() => {
            ...
            post('/app/appuserpaybind/add', values).then(() => {
