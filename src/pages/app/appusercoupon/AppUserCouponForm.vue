<template>
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="兑换码id">
                <a-input placeholder="请输入兑换码id" v-decorator="['couponId']"/>
              </a-form-item>
              ...
              <a-form-item label="是否使用">
                <a-input placeholder="请输入是否使用" v-decorator="['used']"/>
              </a-form-item>

                                
              <a-form-item label="领取时间">
                <a-input placeholder="请输入领取时间" v-decorator="['receiveDate']"/>
              </a-form-item>

                                
              <a-form-item label="使用时间">
                <a-input placeholder="请输入使用时间" v-decorator="['useDate']"/>
              </a-form-item>

                                
              <a-form-item label="失效时间">
                <a-input placeholder="请输入失效时间" v-decorator="['loseDate']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/app/appusercoupon/update', values).then(() => {
            ...
            post('/app/appusercoupon/add', values).then(() => {
