  ...
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="兑换ID">
                <a-input placeholder="请输入兑换ID" v-decorator="['exchangeId']"/>
              </a-form-item>

                                
              <a-form-item label="兑换时间">
                <a-input placeholder="请输入兑换时间" v-decorator="['exchangeDate']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/app/appuserexchangelog/update', values).then(() => {
            ...
            post('/app/appuserexchangelog/add', values).then(() => {
