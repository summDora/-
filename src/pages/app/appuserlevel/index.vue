...
<script>
  ...
  import TableForm from './AppUserLevelForm'
  const Columns = [
              {
          title: "id",
          dataIndex: "id",
          ...
          title: "level_start_name",
          dataIndex: "levelStartName",
          key: "levelStartName",
        },              {
          title: "level_end_name",
          dataIndex: "levelEndName",
          key: "levelEndName",
        },              {
          title: "level_start_exp",
          dataIndex: "levelStartExp",
          key: "levelStartExp",
        },              {
          title: "level_end_exp",
          dataIndex: "levelEndExp",
          key: "levelEndExp",
        },              {
          title: "level_num",
          dataIndex: "levelNum",
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        post("/app/appuserlevel/page", params).then((res) => {
      ...
      // 删除菜单
      deleteRecord(id) {
        post("/app/appuserlevel/delete", [id]).then((res) => {
          if (res.code == 200) {
            this.getTableData();
            this.$message
                    .success(res.msg);
      ...
      select(){
        ...
        get('/app/appuserlevel/select',this.CdtionSearch).then(res=>{
          console.log(res)
        })
      }
