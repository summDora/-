...
<script>
  ...
  import TableForm from './AppUserGiftForm'
  const Columns = [
              {
          title: "id",
          dataIndex: "id",
          ...
          title: "gain_access",
          dataIndex: "gainAccess",
          key: "gainAccess",
        },              {
          title: "gain_condition",
          dataIndex: "gainCondition",
          key: "gainCondition",
        },              {
          title: "award_name",
          dataIndex: "awardName",
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        post("/app/appusergift/page", params).then((res) => {
      ...
      // 删除菜单
      deleteRecord(id) {
        post("/app/appusergift/delete", [id]).then((res) => {
          if (res.code == 200) {
            this.getTableData();
            this.$message
                    .success(res.msg);
      ...
      select(){
        ...
        get('/app/appusergift/select',this.CdtionSearch).then(res=>{
          console.log(res)
        })
      }
