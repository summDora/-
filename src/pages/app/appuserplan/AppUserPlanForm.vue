    ...
    <a-form :form="form" v-bind="layout">
                ...
                <a-date-picker
                    ...
                    :placeholder="`plan_id`"/>
                                                          ...
                                                          <a-form-item label="current_num">
                <a-input placeholder="current_num" v-decorator="['currentNum']"/>
              </a-form-item>
                                      <a-form-item label='current_num'>
                <a-input-number v-decorator="['currentNum' ]" :min="1" :max="999"/>
              </a-form-item>
                                      <a-form-item label="current_num">
                <a-date-picker
                    style="width:100%"
                    show-time
                    v-decorator="[ 'currentNum',]"
                    :placeholder="`current_num`"/>
              </a-form-item>
                                                          <a-form-item label="total_num">
                <a-input placeholder="total_num" v-decorator="['totalNum']"/>
              </a-form-item>
                                      <a-form-item label='total_num'>
                <a-input-number v-decorator="['totalNum' ]" :min="1" :max="999"/>
              </a-form-item>
                                      <a-form-item label="total_num">
                <a-date-picker
                    style="width:100%"
                    show-time
                    v-decorator="[ 'totalNum',]"
                    :placeholder="`total_num`"/>
              </a-form-item>
                                                          <a-form-item label="current_duration">
                <a-input placeholder="current_duration" v-decorator="['currentDuration']"/>
              </a-form-item>
                                      <a-form-item label='current_duration'>
                <a-input-number v-decorator="['currentDuration' ]" :min="1" :max="999"/>
              </a-form-item>
                                      <a-form-item label="current_duration">
                <a-date-picker
                    style="width:100%"
                    show-time
                    v-decorator="[ 'currentDuration',]"
                    :placeholder="`current_duration`"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/app/appuserplan/update', values).then(() => {
            ...
            post('/app/appuserplan/add', values).then(() => {
