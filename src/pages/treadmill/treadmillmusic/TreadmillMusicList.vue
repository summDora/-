...
<script>
  ...
  import TableForm from './TreadmillMusicForm'
  const Columns = [
              {
          title: "ID",
          dataIndex: "id",
          key: "id",
              ...
              {
          title: "类别名称",
          dataIndex: "musicClassName",
          key: "musicClassName",
        },
              {
          title: "类别CODE",
          dataIndex: "musicClassCode",
          key: "musicClassCode",
        },
              {
          title: "音乐名称",
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        postForm("/treadmill/treadmillmusic/page", params).then((res) => {
      ...
      // 删除菜单
      deleteRecord(id) {
        post("/treadmill/treadmillmusic/delete", [id]).then((res) => {
          if (res.code == 200) {
            this.getTableData();
            this.$message
                    .success(res.msg);
