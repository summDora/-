<template>
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="">
                <a-input placeholder="请输入" v-decorator="['maxSpeed']"/>
              </a-form-item>

                                
              <a-form-item label="1.未  2.当前设置">
                <a-input placeholder="请输入1.未  2.当前设置" v-decorator="['status']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/treadmill/treadmillspeed/update', values).then(() => {
            ...
            post('/treadmill/treadmillspeed/add', values).then(() => {
