<template>
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="0.普通 1.线下 2.测试 3.特殊">
                <a-input placeholder="请输入0.普通 1.线下 2.测试 3.特殊" v-decorator="['type']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/treadmill/treadmillwhite/update', values).then(() => {
            ...
            post('/treadmill/treadmillwhite/add', values).then(() => {
