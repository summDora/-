<template>
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="家庭成员用户ID">
                <a-input placeholder="请输入家庭成员用户ID" v-decorator="['familyUserId']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/treadmill/treadmillfamily/update', values).then(() => {
            ...
            post('/treadmill/treadmillfamily/add', values).then(() => {
