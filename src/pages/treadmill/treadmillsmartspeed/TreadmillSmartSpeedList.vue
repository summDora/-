...
<script>
  ...
  import TableForm from './TreadmillSmartSpeedForm'
  const Columns = [
              {
          title: "ID",
          dataIndex: "id",
          ...
          key: "speedName",
              ...
              {
          title: "运动类型(S1初级 S2中级 S3高级 S4专家)",
          dataIndex: "speedCode",
          key: "speedCode",
        },
              {
          title: "随机code(A1 A2 A3)",
          ...
          key: "totalDuration",
              ...
              {
          title: "区间时长",
          dataIndex: "betweenDuration",
          key: "betweenDuration",
        },
              {
          title: "开始时长",
          dataIndex: "startDuration",
          key: "startDuration",
        },
              {
          title: "结束时长",
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        postForm("/treadmill/treadmillsmartspeed/page", params).then((res) => {
      ...
      // 删除菜单
      deleteRecord(id) {
        post("/treadmill/treadmillsmartspeed/delete", [id]).then((res) => {
          if (res.code == 200) {
            this.getTableData();
            this.$message
                    .success(res.msg);
