  ...
  <a-drawer
    ...
    <a-form :form="form" v-bind="layout">
              ...
              <a-form-item label="激活码">
                <a-input placeholder="请输入激活码" v-decorator="['code']"/>
              </a-form-item>

                                
              <a-form-item label="1.未领取 2.已领取 3.已兑换">
                <a-input placeholder="请输入1.未领取 2.已领取 3.已兑换" v-decorator="['status']"/>
              </a-form-item>
    ...
    methods: {
      ...
      submit() {
        this.form.validateFields((err, values) => {
          ...
          if (this.name) {
            post('/treadmill/treadmillactivation/update', values).then(() => {
            ...
            post('/treadmill/treadmillactivation/add', values).then(() => {
